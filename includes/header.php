...
<head>
    ...
    <script src="<?= asset_versioned_path('/assets/design-flow.js') ?>" defer></script>
...
<body>
    ...
    <div class="shell<?= isset($shellClass) ? ' ' . htmlspecialchars($shellClass) : '' ?>">
        ...
        <aside>
            ...
            <div class="sidebar-footer">Built, not
                bought<br><a href="https://rydesignstudios.com/?utm_source=onedesign" target="_blank" rel="noopener"
                    class="sidebar-footer-link">Ryan Pugh</a>
                <a href="https://buymeacoffee.com/ryonline" target="_blank" rel="noopener"
                    class="sidebar-footer-coffee">
                    <svg viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    Buy me a coffee</a>
                <a href="/admin/" class="sidebar-footer-admin">admin</a>
            </div>
        </aside>